<script lang="ts">
    ...
    if (external_links) {
        ...
        if (external_links.website) {
            external_links_content += generate_link(external_links.website, "fa-regular fa-browser", "hover:text-lime-500/30 text-lime-500");
        }
...
<div id="main" class="flex justify-center items-center pt-12">
    <div class="flex flex-row flex-wrap">
        <div class="flex flex-col mx-10 mt-10 justify-center items-center gap-3">
            ...
            <div class="flex flex-row gap-3 text-2xl backdrop-blur-md p-2 rounded-xl bg-black/20">
