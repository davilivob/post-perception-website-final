...
<TailwindCSS />
<div
    class="bg-gradient-to-tl from-blue-900 via-emerald-900 to-fuchsia-900 w-screen h-screen fixed z-[-3]"
/>
<div
    class="bg-gradient-to-bl from-lime-900 via-indigo-900 to-purple w-screen h-screen fixed z-[-1] backdrop-blur-2xl"
/>
<div class="bg-black/70 w-screen h-screen fixed z-[-1] backdrop-blur-2xl" />

<div
    class="w-[10vw] h-[10vw] fixed rounded-full ml-[60vw] mt-[60vh] blur-3xl bg-blue-900/40 z-[-1]"
/>
<div
    class="w-[20vw] h-[20vw] fixed rounded-full ml-[70vw] mt-[50vh] blur-3xl bg-violet-900/40 z-[-1]"
/>
<div
    class="w-[40vw] h-[40vw] fixed rounded-full ml-[80vw] mt-[35vh] blur-3xl bg-red-900/40 z-[-1]"
/>
<main>
    <Cursor />
