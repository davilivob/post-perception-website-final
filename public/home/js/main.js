...
const name = document.querySelector("#work-name");  //作品名稱
const exit = document.querySelector("#exit");  //點模型後需要跳出去的ui
const information = document.querySelector("#work-information");  //資訊欄
const informationText = document.querySelector("#text");  //資訊欄裡面的字
...
//Set Model
const grate = await loadModel('./static/gltf/grate.gltf');
const grate2 = await loadModel('./static/gltf/grate3.gltf');
const grate3 = await loadModel('./static/gltf/grate2.gltf');
const text = await loadModel('./static/gltf/postperception.gltf');

const items = [];
const itemPath = [
    './static/gltf/Item1.gltf',
    './static/gltf/Item2.gltf',
    './static/gltf/Item3.gltf',
    './static/gltf/Item4.gltf',
    './static/gltf/Item5.gltf',
    // './static/gltf/Item6.gltf',
    './static/gltf/Item7.gltf',
    './static/gltf/Item8.gltf',
    './static/gltf/Item9.gltf',
    './static/gltf/Item10.gltf',
    './static/gltf/Item11.gltf',
    './static/gltf/Item12.gltf',
    './static/gltf/Item13.gltf',
];
